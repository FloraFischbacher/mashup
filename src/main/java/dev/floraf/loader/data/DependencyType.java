...
public enum DependencyType {
    /**
     * Also called a "load-order dependency". Mashup will attempt to load this
     * patch, regardless of whether the dependency specified is present.
     * However, if the resource this patch depends on is present, it will be
     * loaded after the specified patch.
     * 
    ...
    /**
     * Also called a "patch-level dependency". Mashup will not load this patch
     * if the resource it depends on is not present. It is important to note
     * that if another patch REQUIREs (see below) a patch that has a firm
    ...
    /**
     * Also called a "mod-level dependency". Mashup will not load the mod this
     * patch is associated with it the resource it depends on is not present.
     */
    EXPECT,
